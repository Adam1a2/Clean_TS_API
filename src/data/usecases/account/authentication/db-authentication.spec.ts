import { AuthenticationParams, LoadAccountByEmailRepository, UpdateAccessTokenRepository, HashComparer, Encrypter, DbAuthentication } from './db-authentication-protocols'
